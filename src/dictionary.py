...
# Варианты/ответы для меню "Работа с файлом"
user_search = {
...
# Варианты/ответы для меню "Полная сортировка данных файла"
user_search_sorted = {
    " 1.Название вакансии\n": "1",
    "2.Город\n": "2",
...
# Варианты/ответы для меню "Работа с вакансиями глубокий поиск"
